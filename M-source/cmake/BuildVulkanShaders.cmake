...
if(NOT SPIRV_OPTIMIZER_PROGRAM)
  ...
  if(NOT SPIRV_OPTIMIZER_PROGRAM_FOUND)
    message(WARNING "spirv-opt binary was not found. Vulkan shaders will be compiled without SPIR-V optimization.")
  endif()
endif()
...
function(generate_shader_file FILE_ARGS1 FILE_ARGS2 FILE_NAME FILE_OUTPUT_NAME)
  ...
  if(SPIRV_OPTIMIZER_PROGRAM_FOUND)
    ...
    list(APPEND SPIRV_OPTIMIZER_COMMAND_LIST COMMAND ${CMAKE_COMMAND} -E copy_if_different "${PROJECT_BINARY_DIR}/${FILE_OUTPUT_NAME}.tmp" "${PROJECT_BINARY_DIR}/${FILE_OUTPUT_NAME}")
  endif()
