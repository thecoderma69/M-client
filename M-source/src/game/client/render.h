...
public:
	...
	void Reset()
	{
		...
		m_TeeRenderFlags = 0;
		m_FeetFlipped = false;
		m_ColorEyeLeft = ColorRGBA(1.0f, 1.0f, 1.0f, 1.0f);
		m_ColorEyeRight = ColorRGBA(1.0f, 1.0f, 1.0f, 1.0f);
		m_UseCustomEyeColors = false;
	...
	ColorRGBA m_ColorEyeLeft;
	ColorRGBA m_ColorEyeRight;
	bool m_UseCustomEyeColors;
	float m_Size;
	bool m_GotAirJump;
