...
private:
	...
	void RenderSettingsTClientLluvia(CUIRect MainView);
	void RenderSettingsTClientAnimeLove(CUIRect MainView);
	void RenderSettingsTClientKeystroke(CUIRect MainView);
	...
	void RenderMaAudio(CUIRect MainView);
	void RenderMaEditorSkins(CUIRect MainView);
	...
	void RenderDevSkin(vec2 RenderPos, float Size, const char *pSkinName, const char *pBackupSkin, bool CustomColors, int FeetColor, int BodyColor, int Emote, bool Rainbow, bool Cute,
		ColorRGBA ColorFeet = ColorRGBA(0, 0, 0, 0), ColorRGBA ColorBody = ColorRGBA(0, 0, 0, 0), ColorRGBA ColorEyeLeft = ColorRGBA(0, 0, 0, 0), ColorRGBA ColorEyeRight = ColorRGBA(0, 0, 0, 0));
