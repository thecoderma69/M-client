...
MACRO_CONFIG_INT(MaStreamChatTextOpacity, ma_stream_chat_text_opacity, 95, 0, 100, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Stream chat message text opacity")
MACRO_CONFIG_COL(MaStreamChatTextColor, ma_stream_chat_text_color, 0xFFFFFFFF, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Stream chat message text color")
MACRO_CONFIG_INT(MaStreamChatOpacity, ma_stream_chat_opacity, 82, 0, 100, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Stream chat background opacity")
...
MACRO_CONFIG_INT(MaStreamActivityFeed, ma_stream_activity_feed, 1, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Show stream activity feed in the stream overlay")
MACRO_CONFIG_INT(MaStreamActivityStats, ma_stream_activity_stats, 1, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Show stream platform statistics in the stream overlay")
MACRO_CONFIG_INT(MaStreamActivityPlatform, ma_stream_activity_platform, 0, 0, 3, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Stream activity source (0=chat platform, 1=Twitch, 2=YouTube, 3=Kick)")
MACRO_CONFIG_INT(MaStreamActivityMaxEvents, ma_stream_activity_max_events, 4, 1, 12, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Maximum stream activity events shown")
MACRO_CONFIG_INT(MaStreamActivityHudX, ma_stream_activity_hud_x, 190, -1000, 1000, CFGFLAG_CLIENT | CFGFLAG_SAVE, "HUD editor X position for stream activity feed")
MACRO_CONFIG_INT(MaStreamActivityHudY, ma_stream_activity_hud_y, 96, -1000, 1000, CFGFLAG_CLIENT | CFGFLAG_SAVE, "HUD editor Y position for stream activity feed")
MACRO_CONFIG_INT(MaStreamActivityHudScale, ma_stream_activity_hud_scale, 100, 25, 300, CFGFLAG_CLIENT | CFGFLAG_SAVE, "HUD editor scale for stream activity feed")
MACRO_CONFIG_INT(MaStreamViewerStats, ma_stream_viewer_stats, 1, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Fetch real stream viewer count from the selected platform")
MACRO_CONFIG_INT(MaStreamViewerStatsRefresh, ma_stream_viewer_stats_refresh, 30, 10, 300, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Seconds between stream viewer count updates")
MACRO_CONFIG_STR(MaStreamStatsTwitchClientId, ma_stream_stats_twitch_client_id, 128, "", CFGFLAG_CLIENT | CFGFLAG_SAVE, "Twitch Helix Client ID for stream viewer statistics")
MACRO_CONFIG_STR(MaStreamStatsTwitchToken, ma_stream_stats_twitch_token, 512, "", CFGFLAG_CLIENT | CFGFLAG_SAVE, "Twitch Helix app/user access token for stream viewer statistics")
MACRO_CONFIG_STR(MaStreamStatsYoutubeApiKey, ma_stream_stats_youtube_api_key, 256, "", CFGFLAG_CLIENT | CFGFLAG_SAVE, "YouTube Data API key for stream viewer statistics")
MACRO_CONFIG_STR(MaStreamStatsKickToken, ma_stream_stats_kick_token, 512, "", CFGFLAG_CLIENT | CFGFLAG_SAVE, "Kick API bearer token for stream viewer statistics")
MACRO_CONFIG_STR(MaStreamStatsKickBroadcasterId, ma_stream_stats_kick_broadcaster_id, 64, "", CFGFLAG_CLIENT | CFGFLAG_SAVE, "Kick broadcaster user ID for stream viewer statistics")
