...
// ===== MA NAME EFFECTS =====
MACRO_CONFIG_INT(MaNameEffects, ma_name_effects, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Enable local visual effects for selected player names")
MACRO_CONFIG_INT(MaNameEffectsOwn, ma_name_effects_own, 1, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Apply MA name effects to your own nameplate")
MACRO_CONFIG_INT(MaNameEffectsOwnMoving, ma_name_effects_own_moving, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Animate MA name effect colors for your local player only")
MACRO_CONFIG_INT(MaNameEffectsOwnStars, ma_name_effects_own_stars, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Show side stars for your local MA name effect")
MACRO_CONFIG_INT(MaNameEffectsOwnStyle, ma_name_effects_own_style, 0, 0, 13, CFGFLAG_CLIENT | CFGFLAG_SAVE, "MA name effect style for your local player only")
MACRO_CONFIG_COL(MaNameEffectsOwnColor1, ma_name_effects_own_color1, 65425, CFGFLAG_CLIENT | CFGFLAG_SAVE | CFGFLAG_COLALPHA, "Primary MA name effect color for your local player only")
MACRO_CONFIG_COL(MaNameEffectsOwnColor2, ma_name_effects_own_color2, 41131, CFGFLAG_CLIENT | CFGFLAG_SAVE | CFGFLAG_COLALPHA, "Accent MA name effect color for your local player only")
MACRO_CONFIG_INT(MaNameEffectsOwnGlow, ma_name_effects_own_glow, 70, 0, 100, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Glow intensity for your local player only")
MACRO_CONFIG_INT(MaNameEffectsFriends, ma_name_effects_friends, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Apply MA name effects to friends without per-player entries")
MACRO_CONFIG_STR(MaNameEffectsNames, ma_name_effects_names, 512, "", CFGFLAG_CLIENT | CFGFLAG_SAVE, "Semicolon separated player names for MA name effects")
MACRO_CONFIG_STR(MaNameEffectsEntries, ma_name_effects_entries, 4096, "", CFGFLAG_CLIENT | CFGFLAG_SAVE, "Per-player MA name effect entries")
MACRO_CONFIG_INT(MaNameEffectsMoving, ma_name_effects_moving, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Animate MA base name effect colors")
MACRO_CONFIG_INT(MaNameEffectsStars, ma_name_effects_stars, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Show side stars for MA base name effects")
MACRO_CONFIG_INT(MaNameEffectsStyle, ma_name_effects_style, 0, 0, 13, CFGFLAG_CLIENT | CFGFLAG_SAVE, "MA base name effect style")
MACRO_CONFIG_COL(MaNameEffectsColor1, ma_name_effects_color1, 65425, CFGFLAG_CLIENT | CFGFLAG_SAVE | CFGFLAG_COLALPHA, "Primary MA base name effect color")
MACRO_CONFIG_COL(MaNameEffectsColor2, ma_name_effects_color2, 41131, CFGFLAG_CLIENT | CFGFLAG_SAVE | CFGFLAG_COLALPHA, "Accent MA base name effect color")
MACRO_CONFIG_INT(MaNameEffectsGlow, ma_name_effects_glow, 70, 0, 100, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Glow intensity for MA base neon name effects")
// ===== KEYSTROKE HUD =====
...
MACRO_CONFIG_INT(TcKeystrokeHudStyle, tc_keystroke_hud_style, 0, 0, 4, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Keystroke HUD visual model (0=normal, 1=round, 2=diamond, 3=hexagon, 4=custom)")
...
MACRO_CONFIG_INT(TcKeystrokeHudSpacePosX, tc_keystroke_hud_space_pos_x, 5, 0, 100, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Space key HUD horizontal position (% of screen)")
MACRO_CONFIG_INT(TcKeystrokeHudSpacePosY, tc_keystroke_hud_space_pos_y, 85, 0, 100, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Space key HUD vertical position (% of screen)")
MACRO_CONFIG_INT(TcKeystrokeHudSpaceSize, tc_keystroke_hud_space_size, 100, 1, 200, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Space key HUD size scale (1-200)")
MACRO_CONFIG_INT(TcKeystrokeHudSpaceAlpha, tc_keystroke_hud_space_alpha, 80, 0, 100, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Space key HUD opacity (0-100)")
MACRO_CONFIG_INT(TcKeystrokeHudSpaceStyle, tc_keystroke_hud_space_style, 0, 0, 4, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Space key HUD visual model (0=normal, 1=round, 2=diamond, 3=hexagon, 4=custom)")
MACRO_CONFIG_COL(TcKeystrokeHudSpaceColorPressed, tc_keystroke_hud_space_color_pressed, 4278190335, CFGFLAG_CLIENT | CFGFLAG_SAVE | CFGFLAG_COLALPHA, "Space key HUD pressed color")
MACRO_CONFIG_COL(TcKeystrokeHudSpaceColorUnpressed, tc_keystroke_hud_space_color_unpressed, 2147483648, CFGFLAG_CLIENT | CFGFLAG_SAVE | CFGFLAG_COLALPHA, "Space key HUD unpressed color")
...
MACRO_CONFIG_INT(TcKeystrokeHudMouseAlpha, tc_keystroke_hud_mouse_alpha, 80, 0, 100, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Mouse click HUD opacity (0-100)")
MACRO_CONFIG_INT(TcKeystrokeHudMouseStyle, tc_keystroke_hud_mouse_style, 0, 0, 4, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Mouse click HUD visual model (0=normal, 1=round, 2=diamond, 3=hexagon, 4=custom)")
MACRO_CONFIG_COL(TcKeystrokeHudMouseColorPressed, tc_keystroke_hud_mouse_color_pressed, 4278190335, CFGFLAG_CLIENT | CFGFLAG_SAVE | CFGFLAG_COLALPHA, "Mouse click HUD pressed color")
MACRO_CONFIG_COL(TcKeystrokeHudMouseColorUnpressed, tc_keystroke_hud_mouse_color_unpressed, 2147483648, CFGFLAG_CLIENT | CFGFLAG_SAVE | CFGFLAG_COLALPHA, "Mouse click HUD unpressed color")
MACRO_CONFIG_STR(TcKeystrokeHudCustomPack, tc_keystroke_hud_custom_pack, 64, "", CFGFLAG_CLIENT | CFGFLAG_SAVE, "Custom keystroke HUD model pack from ma/keystrokes")
