...
MACRO_CONFIG_INT(MaNameEffectsOwnStyle, ma_name_effects_own_style, 0, 0, 3, CFGFLAG_CLIENT | CFGFLAG_SAVE, "MA name effect style for your local player only")
...
MACRO_CONFIG_INT(MaNameEffectsStyle, ma_name_effects_style, 0, 0, 3, CFGFLAG_CLIENT | CFGFLAG_SAVE, "MA base name effect style (0=rainbow, 1=neon, 2=stars, 3=neon stars)")
