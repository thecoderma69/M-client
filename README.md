...
### Tutorial Fuente De Actividad

El tutorial completo para activar `Fuente de actividad` esta en:

```txt
TUTORIAL_FUENTE_DE_ACTIVIDAD.txt
```

Ese archivo explica como activar el chat de stream, configurar Twitch/YouTube/Kick, mover el HUD separado y proteger las claves durante directos.
...
|-- TUTORIAL_FUENTE_DE_ACTIVIDAD.txt # Tutorial para stream y fuente de actividad
